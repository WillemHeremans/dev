...
if($data['pref_1'] == $_COOKIE['pref'] && $data['age'] == $_COOKIE['age'] && $data['gender'] == $_COOKIE['gender']) 
...
else if (($data['pref_1'] == $_COOKIE['pref'] && $data['age'] == $_COOKIE['age']) || ($data['pref_1'] == $_COOKIE['pref'] && $data['gender'] == $_COOKIE['gender']) || ($data['gender'] == $_COOKIE['gender'] && $data['age'] == $_COOKIE['age']))
...
else if ($data['pref_1'] == $_COOKIE['pref'] || $data['age'] == $_COOKIE['age'] ||  $data['gender'] == $_COOKIE['gender'])
...
<div class="card" style="<?php echo $gold ?>">
  ...
  <p class="title"><a href="#"><?php echo $data['age'] ?></a> / <a href="#"><i class="<?php echo $gender ?>"></i></a></p>
  <p>Ma préférence: <a href="#"><b><?php echo $data['pref_1'] ?></b></a></p> 
  <p>Mon lieu: <b><a href="#" style="color:green"><?php echo $data['lieu_1'] ?></a></b></p>
