...
<div class="card">
  ...
  <h1>' .$data['pseudo'].'</h1>
  <p class="title"><a href="age.php">' .$data['age'].'</a> / <a href="gender.php"><i class="' .$gender.'"></i></a></p>
  <p>Ma préférence: <a href="pref.php"><b>' .$data['pref_1']. '</b></a></p> 
  <p>Mon lieu: <b><a href="lieu.php">'.$data['lieu_1'].'</a></b></p>
