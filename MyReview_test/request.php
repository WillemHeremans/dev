...
function addData(){
	...
	$phrase_sql = "INSERT INTO profils (pseudo, age, pref_1, pref_2, pref_3, pref_4, pref_5, lieu_1, lieu_2, lieu_3, lieu_4, lieu_5)
    VALUES (:pseudo, :age, :pref_1, :pref_2, :pref_3, :pref_4, :pref_5, :lieu_1, :lieu_2, :lieu_3, :lieu_4, :lieu_5)";
